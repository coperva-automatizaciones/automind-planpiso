...
Omite cualquier campo que no sea claramente legible. Estructura esperada:
{
  ...
  "enganche":         "enganche, anticipo o pago inicial — busca 'Enganche', 'Anticipo', 'Pago inicial', 'Total pago inicial', 'Down payment'. SOLO dígitos y punto decimal si aplica, sin comas ni símbolo $ (ej: 159000) — omite si no aparece",
