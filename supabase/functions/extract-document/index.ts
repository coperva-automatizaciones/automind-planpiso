...
Omite cualquier campo que no sea claramente legible. Estructura esperada:
{
  ...
  "montoFinanciado":  "monto total a financiar — busca 'Monto a financiar', 'Monto del crédito', 'Monto financiado', 'Saldo a financiar', 'Importe financiado', 'Total financiado'. Es el monto del préstamo, NO el precio de venta. SOLO dígitos y punto decimal si aplica, sin comas ni símbolo $ (ej: 636000) — omite si no aparece explícitamente",
  "enganche":         "busca ÚNICAMENTE el renglón etiquetado exactamente como 'Enganche'. NO uses sinónimos ni campos similares. SOLO dígitos y punto decimal si aplica, sin comas ni símbolo $ (ej: 159000) — omite si no aparece la palabra 'Enganche'",
  "plazoMeses":       "número de mensualidades o plazo en meses — busca 'Plazo', 'Meses', 'Mensualidades', 'Número de pagos'. SOLO el número entero (ej: 48) — omite si no aparece",
  "mensualidad":      "TOTAL del pago mensual completo — busca '(=) Total pago mensual', 'Total mensualidad', 'Pago mensual total', 'Mensualidad total'. IMPORTANTE: el documento puede tener VARIAS líneas de mensualidad (vehículo, seguros, servicios adicionales) — debes tomar ÚNICAMENTE el renglón del TOTAL FINAL, no el de vehículo solo ni el de servicios. El total es el que lleva prefijo '(=)' o la palabra 'Total'. SOLO dígitos y punto decimal, sin comas ni símbolo $ (ej: 23420.34) — omite si no aparece el total explícito",
